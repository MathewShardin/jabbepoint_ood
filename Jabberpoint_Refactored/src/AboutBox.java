...
public class AboutBox {
	public static void show(Frame parent) {
		...
		messageBuilder.append("JabberPoint is a primitive slide-show program in Java(tm).\n")
				...
				.append("Sylvia Stuurman (version 1.2 and higher) for")
				.append("the Open University of the Netherlands, 2002 -- now.\n")
